		...
		<section class="imprints inset">
			<article>
				<h2>
					...
					<div class="subheading">Information in accordance with Section 5 TMG</div>
				</h2>
				<div>
				...
				<div>
					...
					<div>
						<h4>Copyright</h4>
						<p>Our web pages and their contents are subject to German copyright law. Unless expressly permitted by law, every form of utilising, reproducing or processing works subject to copyright protection on our web pages requires the prior consent of the respective owner of the rights. Individual reproductions of a work are only allowed for private use. The materials from these pages are copyrighted and any unauthorised use may violate copyright laws. </p>
					</div>
				</div>
				<div>
			...
			<article>
				<h2>
					<div>Impressum</div>
					<div class="subheading">Angaben gemäß § 5 TMG</div>
				</h2>
				<div>
