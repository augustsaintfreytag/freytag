	...
	<svg style={{ display: "none" }}>
		<symbol id="Arrow Left Symbol" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.912 17.912">
			<g transform="translate(-53.724)">
				<path d="M.923,0V2.936h6.6L0,10.464l2.2,2.2L9.73,5.137v6.6h2.936V0Z" transform="translate(62.68 17.912) rotate(-135)"></path>
			</g>
		</symbol>
		<symbol id="Arrow Right Symbol" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.912 17.912">
			<path d="M.923,0V2.936h6.6L0,10.464l2.2,2.2L9.73,5.137v6.6h2.936V0Z" transform="translate(8.956) rotate(45)"></path>
		</symbol>
