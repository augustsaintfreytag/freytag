<template>
	<section class="privacy-policy-page inset text">
		<article>
			<h2>
				<div>Datenschutzerklärung</div>
				<div class="subheading">Nach Regulation (EU) 2016/679 (General Data Protection Regulation)</div>
			</h2>
			<div>
